...
def process_song_file(cur, filepath):
    """
    Processes a song file and then loads it to the postgres db. 
    """
    # open song file
...
def process_log_file(cur, filepath):
    """
    Processes a log file and then loads it to the postgres db. 
    """
    # open log file
...
def process_data(cur, conn, filepath, func):
    """
    Processes all files in a given file path and processes them. 
    """
...
def main():
    """
    This is the main fuction that will execute the ETL pipeline. 
    """
